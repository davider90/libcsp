...
/**
   Initialize socketcam and add CSP interface.
   ...
   @return The added #csp_iface_t, or NULL in case of failure.
*/
csp_iface_t * csp_can_socketcan_init(const char * device, const char * ifname, int bitrate, bool promisc);

/**
   Stop he Rx thread and free resources.

   @note This will invalidate the CSP, because a interface can't be removed. This is primarily for testing.
